'use strict';
//This was checked on 3/17/2019. Verified OK.
...
function displayPics(){
  ...
  // The reassignment must occurs within the scope in which the variable was declared.
  // There was an attempt to use rando outside the scope in which it was declared, so it was not
  // recognized and an error was thrown.
  console.log(viewed);
