...
// I tried this with =>. There was an error, becuase out of scope. Moved back to original.
console.log(joe);
...
//the scope property of the "joe" instance of the Student constructor function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//the scopeArrow includes the properties of the window
// 3. Explain why "this" is different when an arrow function is used.
// The arrow function does not bind "this. As a result, it bubbles up to the global window object which is the next nearest enclosing scope.
